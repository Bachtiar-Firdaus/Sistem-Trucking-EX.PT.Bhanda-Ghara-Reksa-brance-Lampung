                ...
                <form action="#" id="form" class="form-horizontal">
                    <input type="hidden" value="" name="id"/> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input required name="pricipal" placeholder="pricipal" class="form-control" type="text" onkeydown="upperCaseF(this)">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input name="party" placeholder="party" class="form-control" type="number">
                                <span class="help-block"></span>
                            </div>
                        </div>
