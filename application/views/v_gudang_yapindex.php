...
<div class="container" style="border: 1px solid #cccccc; background-color: #F5F5F5; " >  
  <section class="content-header"><br>
    <h2 class="text-center" style="font-size: 3vw;"><b>GUDANG YAPINDEX</b></h2><br><br>
  </section>
  
  <section class="container-fluid" style="overflow-y: auto; overflow-x: scroll;">
        <button class="btn btn-default" id="btnn2" onclick="reload_table()"><i class="glyphicon glyphicon-refresh"></i> REFRESH</button><br>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('gudang_yapindex/ajax_list')?>",
            "type": "POST"
        },
...
function add_gudang_yapindex()
{
    ...
    $('.modal-title').text('TAMBAH gudang_yapindex'); // Set Title to Bootstrap modal title
}

function edit_gudang_yapindex(id)
{
    save_method = 'update';
    $('#form')[0].reset(); // reset form on modals
    $('.form-group').removeClass('has-error'); // clear error class
    ...
    $.ajax({
        url : "<?php echo site_url('gudang_yapindex/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('gudang_yapindex/ajax_add')?>";
    } else {
        url = "<?php echo site_url('gudang_yapindex/ajax_update')?>";
    }
...
function delete_gudang_yapindex(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('gudang_yapindex/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
<form method="post" accept-charset="utf-8" action="<?php echo base_url()?>c_gudang_yapindex/cetak">
...
<form method="post" accept-charset="utf-8" action="<?php echo base_url()?>c_gudang_yapindex/cetak_full">
    <div class="form-group">
        <div  style="width: 170px;  float: left;">
            <select name = "nobongkar" class="form-control" style="width: 160px; float: left; margin: 5px;">
                <option>Pilih NO STO / BL</option>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input readonly name="nopolisi" placeholder="masukan nomor polisi" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input readonly name="tujuangudang" placeholder="masukan tujuan gudang" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
