...
<div class="container" style="border: 1px solid #cccccc; background-color: #F5F5F5; " >
  <section class="content-header"><br>
    <h2 class="text-center" style="font-size: 3vw;"><b>GUDANG PUNDI</b></h2><br><br>
  </section>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('gudang_pundi/ajax_list')?>",
            "type": "POST"
        },
...
function add_gudang_pundi()
{
    ...
    $('.modal-title').text('TAMBAH gudang_pundi'); // Set Title to Bootstrap modal title
}

function edit_gudang_pundi(id)
{
    save_method = 'update';
    $('#form')[0].reset(); // reset form on modals
    $('.form-group').removeClass('has-error'); // clear error class
    ...
    $.ajax({
        url : "<?php echo site_url('gudang_pundi/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('gudang_pundi/ajax_add')?>";
    } else {
        url = "<?php echo site_url('gudang_pundi/ajax_update')?>";
    }
...
function delete_gudang_pundi(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('gudang_pundi/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                    <input readonly name="nourut" placeholder="masukan no surat jalan" class="form-control" type="text">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                    <input readonly name="timbangkosong" placeholder="masukna jumlah timbang kosong" class="form-control" type="text">
                                    <span class="help-block"></span>
                                    </div>
                                    <div class="col-md-2" style="margin-top: 5px;"><b>Kilogram</b></div>
                                </div>
