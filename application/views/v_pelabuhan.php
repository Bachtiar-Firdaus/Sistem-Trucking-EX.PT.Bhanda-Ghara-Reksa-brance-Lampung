    ...
    <section class="container-fluid" style="overflow-y: auto; overflow-x: scroll;">
        ...
        <div class="container">
            ...
            <?php 
                ...
                $result = $data->row();
                if($result != null){?>
                <button class="btn btn-success" id="btnn" style="width: 110px; margin: 5px;" onclick="add_pelabuhan()"><i class="glyphicon glyphicon-plus"></i> TAMBAH</button>
                <?php }
            ?>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('pelabuhan/ajax_list')?>",
            "type": "POST"
        },
...
function edit_pelabuhan(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('pelabuhan/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('pelabuhan/ajax_add')?>";
    } else {
        url = "<?php echo site_url('pelabuhan/ajax_update')?>";
    }
...
function delete_pelabuhan(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('pelabuhan/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
function cek(){
    if(form.nourut.value != "" && form.nosuratjalan.value != "" && form.nopolisi.value != "" && form.namasupir.value != "" && form.tujuangudang.value != ""){
        save();
    }else{
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">PELABUHAN FORM</h3>
            </div>
                ...
                horizontal">
                    <input type="hidden" value="" name="id"/> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input required name="nourut" maxlength="4" placeholder="masukan no urut" class="form-control" type="text" onkeypress="return hanyaAngka(event)">
...
<!-- 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input required name="nosuratjalan" maxlength="6" placeholder="masukan no surat jalan" class="form-control" type="text" onkeypress="return hanyaAngka(event)">
                                <span class="help-block"></span>
                            </div>
                        </div><br>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input required name="nopolisi" placeholder="masukan no polisi" class="form-control" type="text"onkeydown="upperCaseF(this)">
                                <span class="help-block"></span>
                            </div>
                        </div><br>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input required name="namasupir" placeholder="masukan nama supir" class="form-control" type="text"onkeydown="upperCaseF(this)">
                                <span class="help-block"></span>
                            </div>
                        </div><br>
