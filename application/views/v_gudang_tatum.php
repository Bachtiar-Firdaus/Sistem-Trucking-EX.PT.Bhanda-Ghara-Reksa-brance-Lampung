...
<div class="container" style="border: 1px solid #cccccc; background-color: #F5F5F5; " >  
  <section class="content-header"><br>
    <h2 class="text-center" style="font-size: 3vw;"><b>GUDANG TATUM</b></h2><br><br>
  </section>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('gudang_tatum/ajax_list')?>",
            "type": "POST"
        },
...
function add_gudang_tatum()
{
    ...
    $('.modal-title').text('TAMBAH gudang_tatum'); // Set Title to Bootstrap modal title
}

function edit_gudang_tatum(id)
{
    save_method = 'update';
    $('#form')[0].reset(); // reset form on modals
    $('.form-group').removeClass('has-error'); // clear error class
    ...
    $.ajax({
        url : "<?php echo site_url('gudang_tatum/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('gudang_tatum/ajax_add')?>";
    } else {
        url = "<?php echo site_url('gudang_tatum/ajax_update')?>";
    }
...
function delete_gudang_tatum(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('gudang_tatum/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
<form method="post" accept-charset="utf-8" action="<?php echo base_url()?>c_gudang_tatum/cetak">
...
<form method="post" accept-charset="utf-8" action="<?php echo base_url()?>c_gudang_tatum/cetak_full">
    <div class="form-group">
        <div  style="width: 170px;  float: left;">
            <select name = "nobongkar" class="form-control" style="width: 160px; float: left; margin: 5px;">
                <option>Pilih NO STO / BL</option>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input readonly name="nourut" placeholder="nourut" class="form-control" type="text">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input readonly name="tujuangudang" placeholder="masuka tujuan gudang" class="form-control" type="text">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <label class="control-label col-md-4" style="text-align: left;">Party</label>
                                <div class="col-md-5">
                                <input readonly name="party" placeholder="masukan jumla party" class="form-control" type="text">
                                <span class="help-block"></span>
                                </div>
