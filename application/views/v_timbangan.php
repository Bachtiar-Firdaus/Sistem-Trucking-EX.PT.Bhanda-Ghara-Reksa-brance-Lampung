...
<!-- 
        ...
        <table id="table" class="table table-striped table-bordered display nowrap" cellspacing="0" width="190%">
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input readonly name="tujuangudang" placeholder="" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>        
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input required name="timbangisi" placeholder="masukan jumlah timbang isi" class="form-control" type="number">
                                <span class="help-block"></span>
                            </div>
                            <div class="col-md-3"><p style="padding-top: 8px;"><b>Kilogram</b></p></div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input required name="timbangkosong" placeholder="masukan jumlah timbang kosong" class="form-control" type="number">
                                <span class="help-block"></span>
                            </div>
                            <div class="col-md-3"><p style="padding-top: 8px;"><b>Kilogram</b></p></div>
                        </div>
