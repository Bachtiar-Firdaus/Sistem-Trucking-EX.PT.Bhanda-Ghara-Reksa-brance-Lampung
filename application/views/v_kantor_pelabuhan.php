...
<form method="post" accept-charset="utf-8" action="<?php echo base_url()?>c_pelabuhan/cetak">
    <div class="form-group">
        ...
        <div  style="width: 180px; float: left;">
            <input required required name="tanggal" placeholder="tanggal" value="masukan tanggal" type="date" style="  float: left; width: 167px; margin: 5px; border-radius: 5px; height: 35px;px;">
        </div>
        <div  style="width: 180px; float: left;">
            <input required required name="tanggal1" placeholder="tanggal1" value="masukan tanggal" type="date" style="  float: left; width: 167px; margin: 5px; border-radius: 5px; height: 35px;px;">
        </div>
