...
<div class="container" style="border: 1px solid #cccccc; background-color: #F5F5F5; " >
  ...
  <section class="content-header"><br>
    <h2 class="text-center" style="font-size: 3vw;"><b>GUDANG WATERINDEX</b></h2><br><br>
  </section>
...
<!--         <button class="btn btn-success" id="btnn" onclick="add_gudang_waterindex()"><i class="glyphicon glyphicon-plus"></i> TAMBAH</button> -->
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('gudang_waterindex/ajax_list')?>",
            "type": "POST"
        },
...
function add_gudang_waterindex()
{
    save_method = 'add';
    ...
    $('.modal-title').text('TAMBAH gudang_waterindex'); // Set Title to Bootstrap modal title
}

function edit_gudang_waterindex(id)
{
    save_method = 'update';
    $('#form')[0].reset(); // reset form on modals
    $('.form-group').removeClass('has-error'); // clear error class
    ...
    $.ajax({
        url : "<?php echo site_url('gudang_waterindex/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('gudang_waterindex/ajax_add')?>";
    } else {
        url = "<?php echo site_url('gudang_waterindex/ajax_update')?>";
    }
...
function delete_gudang_waterindex(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('gudang_waterindex/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
<form method="post" accept-charset="utf-8" action="<?php echo base_url()?>c_gudang_waterindex/cetak">
...
<form method="post" accept-charset="utf-8" action="<?php echo base_url()?>c_gudang_waterindex/cetak_full">
    <div class="form-group">
        <div  style="width: 170px;  float: left;">
            <select name = "nobongkar" class="form-control" style="width: 160px; float: left; margin: 5px;">
                <option>Pilih NO STO / BL</option>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input readonly name="tujuangudang" placeholder="masukan nama tujuan gudang" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input readonly name="pricipal" placeholder="Diisi oleh sistem" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input readonly name="keterangan" placeholder="masukan nama pricipal" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-5">
                                <input readonly name="party" placeholder="masukan nama party" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input readonly name="jenispupuk" placeholder="masukan nama jenis pupuk" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input readonly name="timbangisi" placeholder="timbangisi" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                            <div class="col-md-2" style="margin-top: 5px;"><b>Kilogram</b></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input readonly name="beratbersih" placeholder="masukan jumlah berat bersih" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                            <div class="col-md-2" style="margin-top: 5px;"><b>Kilogram</b></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input readonly name="tanggal" placeholder="masukan tanggal" class="form-control datepicker" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input readonly name="brangkat" placeholder="masukan waktu berangkat" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                            <div class="form-group">
