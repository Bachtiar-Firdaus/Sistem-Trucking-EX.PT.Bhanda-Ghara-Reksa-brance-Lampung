...
<div class="container" style="border: 1px solid #cccccc; background-color: #F5F5F5; " ><br><br>
  <section class="content-header">
    <h2 class="text-center" style="font-size: 3vw;"><b>GUDANG YAPINDEX</b></h2>
  </section><br>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('kantor_gudang_yapindex/ajax_list')?>",
            "type": "POST"
        },
...
function add_kantor_gudang_yapindex()
{
    save_method = 'add';
    ...
    $('.modal-title').text('TAMBAH kantor_gudang_yapindex'); // Set Title to Bootstrap modal title
}

function edit_kantor_gudang_yapindex(id)
{
    save_method = 'update';
    $('#form')[0].reset(); // reset form on modals
    $('.form-group').removeClass('has-error'); // clear error class
    ...
    $.ajax({
        url : "<?php echo site_url('kantor_gudang_yapindex/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('kantor_gudang_yapindex/ajax_add')?>";
    } else {
        url = "<?php echo site_url('kantor_gudang_yapindex/ajax_update')?>";
    }
...
function delete_kantor_gudang_yapindex(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('kantor_gudang_yapindex/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                ...
                <form action="#" id="form" class="form-horizontal">
                    <input type="hidden" value="" name="id"/> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input required name="tujuangudang" placeholder="masukan nama gudang" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input required name="beratbersih" placeholder="masukan berat bersih" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input required name="tanggal" placeholder="masukan tanggal keberangkatan" class="form-control datepicker" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input required name="brangkat" placeholder="masukan waktu keberangkat" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                            <div class="form-group">
