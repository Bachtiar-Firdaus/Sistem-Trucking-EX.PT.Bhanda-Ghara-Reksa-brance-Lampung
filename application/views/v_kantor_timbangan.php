...
<div class="container" style="border: 1px solid #cccccc; background-color: #F5F5F5; " ><br><br>
  ...
  <section class="content-header">
    <h2 class="text-center" style="font-size: 3vw;"><b>DATA TIMBANGAN</b></h2>
  </section>
...
<!-- 
        <button class="btn btn-success" id="btnn" onclick="add_kantor_timbangan()"><i class="glyphicon glyphicon-plus"></i> TAMBAH</button> -->
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('kantor_timbangan/ajax_list')?>",
            "type": "POST"
        },
...
function add_kantor_timbangan()
{
    ...
    $('.modal-title').text('TAMBAH kantor_timbangan'); // Set Title to Bootstrap modal title
}

function edit_kantor_timbangan(id)
{
    save_method = 'update';
    $('#form')[0].reset(); // reset form on modals
    $('.form-group').removeClass('has-error'); // clear error class
    ...
    $.ajax({
        url : "<?php echo site_url('kantor_timbangan/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('.modal-title').text('kantor_timbangan FORM'); // Set title to Bootstrap modal title////////datepicker
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('kantor_timbangan/ajax_add')?>";
    } else {
        url = "<?php echo site_url('kantor_timbangan/ajax_update')?>";
    }
...
function delete_kantor_timbangan(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('kantor_timbangan/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
function cek(){
    if(form.timbangisi.value != "0" && form.timbangkosong.value != "0" && form.timbangisi.value != "" && form.timbangkosong.value != ""){
        save();
    }else{
    ...
    <div class="modal-dialog" style="width: 1000px;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">kantor_timbangan FORM</h3>
            </div>
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input readonly name="brangkat" placeholder="masukan berangkat" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <button type="button" class="btn btn-danger" data-dismiss="modal" style="width: 100px; background-color: #058C97; margin-left: 10px;">Batal</button>
